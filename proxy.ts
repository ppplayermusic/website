...
export default function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    img-src 'self' blob: data: https://ppplayer.com https://flagcdn.com https://www.googletagmanager.com https://*.googlesyndication.com https://*.doubleclick.net https://*.google.com https://*.google.com.br https://*.google.es https://*.google-analytics.com https://*.adtrafficquality.google https://*.analytics.google.com;
    connect-src 'self' https://*.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com https://*.google.com https://*.google.es https://*.adtrafficquality.google https://*.googlesyndication.com https://*.doubleclick.net;
