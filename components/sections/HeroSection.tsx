      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full text-center z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button href={DOWNLOAD_LINKS.ios} size="lg" className="rounded-full px-8 bg-white text-black hover:bg-slate-200 border-none font-semibold">
              Get for iOS
            </Button>
            <Button href={DOWNLOAD_LINKS.android} size="lg" variant="glass" className="rounded-full px-8 border-white/10 text-white hover:bg-white/5">
              Get for Android
            </Button>
            <Button href={DOWNLOAD_LINKS.windows} size="lg" variant="glass" className="rounded-full px-8 border-white/10 text-white hover:bg-white/5">
              Get for Windows
            </Button>
          </div>
        </motion.div>
