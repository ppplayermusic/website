  ...
  return (
    <section className="py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          {/* Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-purple-950/60 via-[#0d0d1e] to-blue-950/40" />
          ...
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-blue-600/10 rounded-full blur-[60px] pointer-events-none" />
